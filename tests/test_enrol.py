...
with sync_playwright() as pw:
    ...
    check("plan reflects Advanced + some experience", pl['s'].startswith("Parts A") and pl['h']=="≈17 h", pl)
    ...
    print("\n== COMPLETION RECORD ==")
    p.evaluate("""()=>{const K='vkp.oxyvent.v4';const s=JSON.parse(localStorage.getItem(K));
