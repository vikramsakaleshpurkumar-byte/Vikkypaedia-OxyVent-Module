...
with sync_playwright() as pw:
    ...
    print("\n== RESULTS ==")
    p.fill("#srchInput","oxygen"); p.wait_for_timeout(400)
    ...
    print("\n== LOCKED UNITS ==")
    p.fill("#srchInput","PALICC-2"); p.wait_for_timeout(450)
    ...
    print("\n== NAVIGATION ==")
    p.fill("#srchInput","pulse oximetry"); p.wait_for_timeout(450)
    ...
    p.fill("#srchInput","begin with a description"); p.wait_for_timeout(450)
